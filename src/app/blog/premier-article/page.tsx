      ...
      <article className="max-w-3xl mx-auto relative z-10">
        ...
        <header className="mb-16 border-b border-white/10 pb-12">
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <div className="flex gap-2">
              {['Next.js', 'React', 'TypeScript'].map((tag, index) => (
                <span
                  key={index}
        ...
        <div ref={contentRef} className="article-content prose prose-invert prose-lg max-w-none">
          <p className="text-xl opacity-90 leading-relaxed mb-8">
            Bienvenue sur mon blog ! Pour ce premier article, je voulais partager avec vous mon expérience dans la création de ce portfolio avec Next.js.
          </p>
          ...
          <p className="opacity-90 mb-6">
            Next.js s'est imposé comme un choix évident pour plusieurs raisons :
          </p>
          ...
          <ul className="space-y-3 mb-10">
            {[
              ...
              "Déploiement simplifié avec Vercel"
            ].map((item, index) => (
          ...
          <p className="opacity-90 mb-6">
            Le plus grand défi a été l'implémentation des animations fluides tout en maintenant de bonnes performances. GSAP s'est révélé être un excellent choix pour gérer ces animations complexes.
          </p>
          
          <div className="my-12 p-6 bg-gradient-to-r from-orange-400/10 to-pink-500/10 rounded-xl border border-white/10">
            <h3 className="text-xl font-semibold mb-4 text-orange-400">Astuce Pro</h3>
            <p className="opacity-90 mb-0">
              Utilisez ScrollTrigger de GSAP avec Lenis pour un défilement parfaitement fluide et des animations précises.
            </p>
          </div>
          
          <p className="opacity-90">
            Après plusieurs itérations, j'ai réussi à créer une expérience utilisateur immersive qui met en valeur mes projets tout en conservant une performance optimale.
          </p>
          ...
          <p className="opacity-90">
            Créer ce portfolio avec Next.js a été une expérience incroyablement enrichissante. J'ai pu explorer des technologies modernes et repousser les limites de ce que je pensais possible en matière d'animations web.
          </p>
        </div>
